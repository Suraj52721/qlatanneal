...
\newtcolorbox{keyeq}[1][]{%
  ...
  fonttitle=\bfseries\color{qnavy},title={#1}}
...
\newtcolorbox{notebox}[1][Note]{%
  ...
  left=4mm,right=3mm,top=2mm,bottom=2mm,
  fonttitle=\bfseries\sffamily\color{qteal!50!black},title={#1}}
...
\newtcolorbox{warnbox}[1][Warning]{%
  ...
  left=4mm,right=3mm,top=2mm,bottom=2mm,
  fonttitle=\bfseries\sffamily\color{qamber!85!black},title={#1}}
...
\newtcolorbox{physbox}[1][Physical picture]{%
  ...
  left=4mm,right=3mm,top=2mm,bottom=2mm,
  fonttitle=\bfseries\sffamily\color{qplum},title={#1}}

% API signature box
\newtcolorbox{apibox}[1]{%
  enhanced,breakable,colback=white,colframe=qblue!55,boxrule=0.5pt,arc=1.5mm,
  left=3.5mm,right=3mm,top=2mm,bottom=2mm,
  attach boxed title to top left={yshift=-2.6mm,xshift=3mm},
  boxed title style={colback=qblue,arc=1mm,boxrule=0pt,
    top=0.6mm,bottom=0.6mm,left=1.6mm,right=1.6mm},
...
\fancyhead[R]{\small\sffamily\color{qgray}\qv{} 0.6.1}
...
\centering
{\Large\color{qnavy}\bfseries Version 0.6.1}\\[1.2em]
{\large\color{qgray}
Simulated Annealing \,\textbullet\, Simulated Quantum Annealing\\[0.25em]
Quantum Parallel Tempering \,\textbullet\, Continuous-Time PIMC\\[0.25em]
and the Optimal Adaptive $\Jp$ Schedule}\\[2.2em]
...
\input{chapters/02_math_foundations}
\input{chapters/03_statmech}

\part{The Annealing Engines}
\input{chapters/04_simulated_annealing}
\input{chapters/05_sqa}
\input{chapters/06_sqapt}
\input{chapters/07_ctpimc}

\part{The Optimal Adaptive Schedule}
\input{chapters/08_optimal_schedule}

\part{Using the Library}
\input{chapters/09_installation}
\input{chapters/10_api}
\input{chapters/11_examples}
\input{chapters/12_hpc}
\input{chapters/13_troubleshooting}
\input{chapters/14_cpp}
